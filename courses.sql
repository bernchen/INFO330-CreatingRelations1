-- courses table
CREATE TABLE courses (code varchar(40) PRIMARY KEY NOT NULL, 
	description varchar(400), start DATE NOT NULL, end DATE NOT NULL, 
	CHECK(LENGTH(code)>=7), CHECK (end > start) );
